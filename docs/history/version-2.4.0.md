...
* Job references can override Node Filters. See updates to [XML](/manpages/man5/job-v20.md#jobref] and [YAML](/manpages/man5/job-yaml-v12.md#job-reference-entry] job definition formats as well.
